...
| **Tab** | Tablature view of the current practice exercise — linked both ways with the Fretboard (root, scale, mode, pattern, direction). Horizontal tab in fit-to-screen systems or one scrolling line, a vertical time-flows-down view, and three text sizes. |
